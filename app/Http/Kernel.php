...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'pessenger.auth' => \App\Http\Middleware\RedirectIfNotPessenger::class,
        'pessenger.guest' => \App\Http\Middleware\RedirectIfPessenger::class,
        // 'pessenger.verified' => \App\Http\Middleware\EnsurePessengerEmailIsVerified::class,
        // 'pessenger.password.confirm' => \App\Http\Middleware\RequirePessengerPassword::class,
